...
(function () {
  ...
  var css = [
    ...
    "#lmy-chat-form{flex:none;display:flex;gap:8px;padding:12px;border-top:1px solid #eee;background:#fff}",
    "#lmy-chat-input{flex:1;resize:none;border:1px solid #ddd;border-radius:12px;padding:9px 12px;",
    "font:500 13.5px 'Archivo',sans-serif;max-height:80px;outline:none}",
    ...
    "@media (max-width:480px){#lmy-chat-panel{right:10px;left:10px;width:auto;bottom:88px}}",
  ].join("");
